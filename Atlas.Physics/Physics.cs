...
public static class Physics
{
    ...
    private static Vector2 _gravity = new Vector2(0f, -9.82f);
    ...
    internal static List<PhysicsObject> PhysicsObjects = new List<PhysicsObject>();
    ...
    {
        float delta = (float)Time.tickDeltaTime;
        if (!_tickPhysics)
