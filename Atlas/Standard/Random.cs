...
public static class ARandom
{
    ...
    /// <returns>A random double precision floating-point value between 0 and 1</returns>
    public static double ValueDouble()
    {
        return _random.NextDouble();
    }

    /// <returns>A random Vector2 where each component is between -1 and 1</returns>
