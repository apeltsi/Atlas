...
namespace SolidCode.Atlas.Rendering
{
    ...
    public class Window
    {
        ...
        void CreateResources()
        {
            ...
            postProcess = new PostProcessStep[4];
            if (DoPostProcess)
            {
                postProcess[0] = new PostProcessStep(_graphicsDevice, new[] { MainSceneResolvedColorView }, "post/bright/shader", framebuffers[0]);
                postProcess[1] = new PostProcessStep(_graphicsDevice, new[] { ColorViews[0] }, "post/blur_horizontal/shader", framebuffers[1]);
                postProcess[2] = new PostProcessStep(_graphicsDevice, new[] { ColorViews[1] }, "post/blur_vertical/shader", framebuffers[2]);
                postProcess[3] = new PostProcessStep(_graphicsDevice, new[] { MainSceneResolvedColorView, ColorViews[2] }, "post/combine/shader");
            }
        }
