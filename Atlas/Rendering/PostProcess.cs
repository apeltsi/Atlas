namespace SolidCode.Atlas.Rendering
{
    ...
    public class PostProcessStep : Drawable
    {
        ...
        public PostProcessStep(GraphicsDevice _graphicsDevice, Veldrid.TextureView[] textures, string path, Veldrid.Framebuffer? buffer = null)
        {
            this._shader = path;
