...
public class FXAAEffect : PostProcessEffect
{
    ...
    public override TextureView CreateResources(TextureView textureView)
    {
        if (Renderer.GraphicsDevice == null)
            throw new NullReferenceException("Graphics device is null! FXAA cannot be created.");
        ...
        var bufferDescription = new FramebufferDescription(null, _textures[0]);
