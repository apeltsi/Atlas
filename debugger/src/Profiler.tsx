...
var [options, setOptions] = createSignal({
    ...
    tooltip: {
        ...
        custom: (s: any, seriesIndex: any, dataPointIndex: any, w: any) => {
            ...
            returnValue += "<span>Total Render Time: " + totalTime.toFixed(2) + "ms</span><br/>";
...
export default function Profiler() {
    ...
    return (<SolidApexCharts options={options()} width={1500} type={"line"} series={series()}></SolidApexCharts>)
}